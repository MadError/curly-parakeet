...
%-------------------------------------------------------------------------
\begin{table}[t]
\caption{Comparison of LOTS with other datasets.}
\label{data_comp}
\resizebox{\columnwidth}{!}{
%\scriptsize
\begin{tabular}{l|l|l|l|l|l}
                  & PIE & JAAD & STIP & LOTS \\\hline
\# scenarios      & - & 346     &  556    & 644     &  1308    \\
%\# frames         &  911K   &  82K    & 1.1M     &  -    &  261K (approx)    \\
RGB Images        &  \cmark   &  \cmark    &   \cmark   & \cmark     &  \cmark    \\
LiDAR Point Cloud &  \xmark   & \xmark     &    \xmark  &  \cmark    &  \cmark    \\
\# Agent type &  1   &  1     &    1  &  8    &  3    \\
Type of Scenario     &  \xmark   & \xmark     &    \xmark  &  \xmark   & \cmark     \\
Traffic Configuration & \xmark    & \xmark     &    \xmark  &  \xmark    & \cmark  \\
Action Order & \xmark    & \xmark     &    \xmark  &  \xmark    & \cmark
